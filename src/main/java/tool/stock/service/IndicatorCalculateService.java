...
import tool.stock.repository.StockIndicatorDailyRepository;
...
public class IndicatorCalculateService {
    ...
    private BigDecimal calcPctChange(List<StockPriceDaily> series, int currentIndex) {
        ...
        return BigDecimalUtils.percentageChange(series.get(currentIndex).getClosePrice(), series.get(currentIndex - 1).getClosePrice(), 4);
    }
}
