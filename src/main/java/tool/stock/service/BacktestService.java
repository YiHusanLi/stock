...
import tool.stock.repository.StrategyBacktestResultRepository;
import tool.stock.repository.StrategySignalRepository;
import tool.stock.util.BigDecimalUtils;
...
public class BacktestService {
    ...
    public int backtest(LocalDate startDate, LocalDate endDate) {
        ...
        for (StrategySignal signal : signals) {
            List<StockPriceDaily> series = stockPriceDailyRepository.findByStockCodeOrderByTradeDateAsc(signal.getStockCode())
                    .stream()
