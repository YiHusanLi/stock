...
public class SignalQueryResponse {
    ...
    public boolean isSqueezeBurst() {
        return squeezeBurst;
    }

    public void setSqueezeBurst(boolean squeezeBurst) {
        this.squeezeBurst = squeezeBurst;
    }

    public boolean isMultiMaBreak() {
        return multiMaBreak;
    }

    public void setMultiMaBreak(boolean multiMaBreak) {
    ...
    public void setTrendBreak(boolean trendBreak) {
