 ...
 */
@Entity
@Table(name = "strategy_backtest_result",
        uniqueConstraints = @UniqueConstraint(name = "uk_strategy_backtest_strategy_stock_date", columnNames = {"strategy_code", "stock_code", "signal_date"}))
